...
function cargarUsuarios() {
    fetch(`http://107.21.218.205:7000/api/negocio/${codigoNegocio}/usuarios`)
        .then(res => res.json())
        .then(data => {
...
userForm.addEventListener('submit', e => {
    ...
    fetch("http://107.21.218.205:7000/api/usuarios", {
        method: "POST",
...
editForm.addEventListener('submit', e => {
    ...
    fetch(`http://107.21.218.205:7000/api/usuarios/${selectedUserId}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
